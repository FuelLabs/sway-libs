...
///
/// ```sway
/// use asset::base::{_set_symbol, _symbol};
/// use std::string::String;
///
/// storage {
///     symbol: StorageMap<AssetId, StorageString> = StorageMap {},
...
///
/// ```sway
/// use asset::base::{_set_decimals, _decimals};
///
/// storage {
///     decimals: StorageMap<AssetId, u8> = StorageMap {},
/// }
