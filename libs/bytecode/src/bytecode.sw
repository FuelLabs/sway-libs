...
///
/// ```sway
/// use bytecode::{compute_bytecode_root, BytecodeRoot, ContractConfigurables};
///
...
///
/// ```sway
/// use bytecode::{compute_predicate_address, ContractConfigurables};
///
/// fn foo(my_bytecode: Vec<u8>, my_configurables: Option<ContractConfigurables>) {
///     let mut my_bytecode = my_bytecode;
...
///
/// ```sway
/// use bytecode::{predicate_address_from_root, BytecodeRoot};
///
...
///
/// ```sway
/// use bytecode::{sway_configurables, ContractConfigurables};
///
...
///
/// ```sway
/// use bytecode::{verify_contract_bytecode, ContractConfigurables};
///
