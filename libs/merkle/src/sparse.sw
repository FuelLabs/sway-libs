...
impl InclusionProof {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::InclusionProof;
    ///
    /// fn foo() {
...
impl ExclusionLeafData {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::ExclusionLeafData;
    ///
    /// fn foo() {
...
impl ExclusionLeaf {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::ExclusionLeaf;
    ///
    ...
    ///
    /// ```sway
    /// use merkle::sparse::{ExclusionLeaf, ExclusionLeafData};
    ///
    /// fn foo(exclusion_leaf: ExclusionLeaf) {
...
impl ExclusionProof {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::{ExclusionProof, ExclusionLeaf};
    ///
    /// fn foo() {
    ///     let proof_set = ProofSet::new()
    ...
    ///
    /// ```sway
    /// use merkle::sparse::ExclusionProof;
    ///
...
impl Proof {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::{Proof, InclusionProof};
    ///
    /// fn foo(proof: Proof) {
    ...
    ///
    /// ```sway
    /// use merkle::sparse::{Proof, MerkleTreeKey, InclusionProof};
    /// use merkle::common::{ProofSet, MerkleRoot};
    /// use std::bytes::Bytes;
    ///
    /// fn foo() {
