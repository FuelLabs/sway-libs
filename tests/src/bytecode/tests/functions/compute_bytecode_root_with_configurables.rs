use crate::bytecode::tests::utils::{
    ...
    test_helpers::{build_configurables, contract_bytecode, defaults, predicate_bytecode, simple_contract_bytecode_root_with_configurables_from_file, simple_predicate_bytecode_root_with_configurables_from_file, test_contract_instance},
};
...
mod success {
    ...
    async fn compute_bytecode_root_with_configurables_of_contract() {
        ...
        let file_bytecode_root = simple_contract_bytecode_root_with_configurables_from_file(config_value as u64).await;

        // Call the contract and compute the bytecode root
        let result_bytecode_root = compute_bytecode_root_with_configurables(&test_contract_instance, file_bytecode, my_configurables).await;
    ...
    async fn compute_bytecode_root_with_configurables_of_predicate() {
        ...
        let predicate_bytecode_root = simple_predicate_bytecode_root_with_configurables_from_file(wallet.clone(), config_value as u64).await;
