use crate::bytecode::tests::utils::{
    ...
    test_helpers::{
        build_configurables, contract_bytecode, defaults, deploy_simple_contract_from_bytecode,
        predicate_bytecode, setup_predicate_from_bytecode, spend_predicate, test_contract_instance,
    },
};
