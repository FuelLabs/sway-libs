use crate::bytecode::tests::utils::{
    ...
    test_helpers::{contract_bytecode, deploy_simple_contract_from_file, predicate_bytecode, test_contract_instance},
};
...
mod success {
    ...
    async fn verify_bytecode_root_of_contract() {
       ...
       verify_contract_bytecode(&test_contract_instance, file_bytecode, id, simple_contract_instance).await;
    }
}
