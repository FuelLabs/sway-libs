...
type ColorName = 'chrome' | 'black1' | 'white1' | 'white2' | 'white3' | 'white4' | 'gray1' | 'gray2' | 'gray3' | 'gray4' | 'gray5' | 'gray6' | 'gray7' | 'gray8' | 'sgreen1' | 'disabled1' | 'disabled2' | 'disabled3';
...
export default function useTheme() {
  ...
  const themeColor = useCallback((name: ColorName) => COLORS[name][currentTheme as 'light' | 'dark'], [currentTheme]);
  return {
    theme: currentTheme,
    setTheme,
    themeColor,
