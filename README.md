...
<p align="center">
    ...
    <a href="https://crates.io/crates/forc/0.68.5" alt="forc">
        <img src="https://img.shields.io/badge/forc-v0.68.5-orange" />
    </a>
...
There are two sets of tests that should be run: inline tests and sdk-harness tests. Please make sure you are using `forc v0.68.5` and `fuel-core v0.43.2`. You can check what version you are using by running the `fuelup show` command.
...
> **NOTE:**
> All projects currently use `forc v0.68.5`, `fuels-rs v0.70.0` and `fuel-core v0.43.2`.
